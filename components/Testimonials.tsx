...
const testimonials = [
  ...
  },
  {
    name: 'Juli',
    role: 'Partecipante al corso',
    text: 'Mi sono sentita subito coinvolta dallo stile di Sarah: autentico, esperto e amorevole. Ti accompagna passo dopo passo con comprensione e senza pressioni. Per noi, questo corso e stato rivoluzionario. Lo consiglio senza riserve.',
    stars: 5,
    image: null,
    gradient: 'from-blush-300 to-blush-400',
    initials: 'J',
