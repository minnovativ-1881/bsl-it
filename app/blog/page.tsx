...
const articles = [
  ...
  {
    slug: 'addormentamento-autonomo-bebe',
    title: 'Addormentamento autonomo del bebè: la guida completa',
    excerpt: 'Come aiutare il tuo bambino ad addormentarsi da solo — senza pianti e nel rispetto del legame.',
    category: 'Addormentamento Autonomo',
    image: '/images/addormentamento-autonomo-bebe.webp',
    readTime: '12 min di lettura',
  },
  {
    slug: 'anticipare-nanna-bambino',
    title: 'Anticipare la nanna del bambino: ecco come',
    excerpt: 'Un orario della nanna anticipato migliora il sonno notturno. Scopri quando e come farlo funzionare.',
    category: 'Routine del Sonno',
    image: '/images/anticipare-nanna-bambino.webp',
    readTime: '11 min di lettura',
  },
  {
    slug: 'bambino-dorme-solo-al-seno',
    title: 'Il bambino dorme solo al seno? Cosa fare',
    excerpt: 'Se il tuo bambino si addormenta solo allattando, sei in buona compagnia. Ecco come cambiare dolcemente.',
    category: 'Allattamento e Sonno',
    image: '/images/bambino-dorme-solo-al-seno.webp',
    readTime: '7 min di lettura',
  },
  {
    slug: 'bambino-non-dorme-giorno',
    title: 'Il bambino non dorme di giorno? Cause e soluzioni',
    excerpt: 'I pisolini sono fondamentali per il sonno notturno. Scopri perché il tuo bambino resiste e come aiutarlo.',
    category: 'Sonno Diurno',
    image: '/images/bambino-non-dorme-giorno.webp',
    readTime: '10 min di lettura',
  },
  {
    slug: 'bambino-piange-nanna',
    title: 'Il bambino piange al momento della nanna: cosa fare',
    excerpt: 'Piangere prima di dormire è normale, ma estenuante. Ecco le cause e le strategie più dolci.',
    category: 'Pianto e Sonno',
    image: '/images/bambino-piange-nanna.webp',
    readTime: '11 min di lettura',
  },
  {
    slug: 'bebe-sveglia-2-ore',
    title: 'Il bebè si sveglia ogni 2 ore di notte: è normale?',
    excerpt: 'Quanto spesso dovrebbe dormire un neonato? E da quando può dormire tutta la notte? Risposte oneste.',
    category: 'Sonno Notturno',
    image: '/images/bebe-sveglia-2-ore.webp',
    readTime: '8 min di lettura',
  },
  {
    slug: 'fabbisogno-sonno-bambino',
    title: 'Fabbisogno di sonno del bambino: quanto deve dormire?',
    excerpt: 'Una tabella chiara per ogni età — dal neonato al bambino di 6 anni — con consigli pratici.',
    category: 'Fabbisogno di Sonno',
    image: '/images/fabbisogno-sonno-bambino.webp',
    readTime: '9 min di lettura',
  },
  {
    slug: 'metodo-pal',
    title: 'Il Metodo PAL: Pianto Abbracciato con Amore',
    excerpt: 'Un metodo delicato basato sul lavoro della Dr. Aletha Solter. Come funziona e quando usarlo.',
    category: 'Metodi del Sonno',
    image: '/images/metodo-pal.webp',
    readTime: '6 min di lettura',
  },
  {
    slug: 'smettere-allattare-dormire',
    title: 'Smettere di allattare per dormire: guida passo dopo passo',
    excerpt: 'Se il tuo bambino si addormenta solo al seno, esistono alternative dolci. Ecco come fare la transizione.',
    category: 'Allattamento e Sonno',
    image: '/images/smettere-allattare-dormire.webp',
    readTime: '12 min di lettura',
  },
]
